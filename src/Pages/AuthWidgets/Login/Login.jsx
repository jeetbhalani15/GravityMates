    ...
    <div className="h-screen flex justify-center bg-zinc-200 dark:bg-[#000000ab] ">
      <div className="flex lg:w-1/2 justify-center items-center space-y-8">
        <div className="w-[85%]  px-8 md:px-32 lg:px-24">
          <form
            onSubmit={(e) => loginHandler(e, userData)}
          ...
          >
            ...
            <button
              ...
              type="submit"
              className="block w-full bg-slate-500 mt-5 py-2 rounded-2xl hover:bg-slate-400 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2"
            >
              Login as a Guest
            </button>
