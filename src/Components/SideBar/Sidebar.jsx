...
function Sidebar() {
  ...
  return (
    <>
    <div className="flex items-center justify-around  w-full p-2 fixed bottom-0 bg-white lg:absolute lg:left-44 lg:top-8 lg:mb-12 z-20 lg:flex-col lg:w-60 lg:h-fit lg:items-start lg:p-8 lg:bg-zinc-200  lg:rounded-tl-3xl lg:pb-[25.8rem] dark:bg-[#282828] dark:text-white">
     ...
     <div className=' flex lg:hidden items-center gap-3 cursor-pointer rounded-lg  py-4 pl-2 pr-8'>
       <GrAddCircle size={20}/>
     </div>
