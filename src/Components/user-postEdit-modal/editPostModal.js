      ...
      <form onSubmit={handleNewEditedPostSubmit}>
        <div className=" relative flex gap-6 justify-center flex-col items-center rounded-lg border-slate-800 border-2 w-fit p-4 z-20  bg-slate-300 lg:w-96 dark:bg-[#1a1919]">
          ...
          <span className=" absolute top-[10px] right-[14px] hover:bg-slate-400 ">
            <IoIosClose onClick={() => setShowEditModal(false)} size={25} />
          </span>
          <div className="flex items-start gap-6">
            <div className="w-20 lg:w-22 ">
              ...
              />
              <img
                className="w-24 mt-8 rounded-[5px]"
                src={postsData?.img}
                alt=""
              />
            </div>
          ...
          <div className="flex gap-2">
            <label
              className="flex p-2 items-center gap-2 rounded-md bg-slate-400 dark:bg-[#8688885c]"
              htmlFor="image"
            >
              <BiImageAdd />
              Add Image
            ...
            <button className="p-2 flex items-center gap-2 rounded-md  bg-slate-400 dark:bg-[#8688885c]">
              <MdPostAdd />
