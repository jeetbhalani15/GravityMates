  ...
  return (
    <>
      <div className=" backdrop-blur-sm bg-gray-800/70 flex items-center justify-around  w-full p-2 fixed bottom-0 bg-white lg:absolute lg:left-44 lg:top-8 lg:mb-12 z-20 lg:flex-col lg:w-60 lg:h-fit lg:items-start lg:p-8 lg:bg-zinc-200  lg:rounded-tl-3xl lg:pb-[25.8rem] dark:bg-[#282828] dark:text-white">
        ...
        <Link to={"/home"}>
          <div className="flex items-center  gap-4 cursor-pointer hover:bg-[aliceblue] dark:hover:bg-[#5556565c] rounded-lg  py-4 pl-2 pr-8">
            <FiHome size={20} />
        ...
        <Link to={"/bookmark"}>
          <div className="hidden lg:flex items-center gap-3 cursor-pointer hover:bg-[aliceblue] dark:hover:bg-[#5556565c] rounded-lg   py-4 pl-2 pr-8">
            <BsBookmark size={20} />
        ...
        <div
          className=" lg:hidden  items-center gap-3 cursor-pointer hover:bg-[aliceblue] dark:hover:bg-[#5556565c] rounded-lg   py-4  pr-10"
        ...
        <Link to={"/bookmark"}>
          <div className="lg:hidden  items-center gap-3 cursor-pointer hover:bg-[aliceblue] dark:hover:bg-[#5556565c] rounded-lg   py-4 pl-2 pr-8">
            <BsBookmark size={20} />
            <span className="hidden lg:block">Bookmark</span>
          </div>
        </Link>
        <Link to={`/profile/${userData?.user?.username}`}>
          <div className=" hidden lg:flex lg:items-center lg:gap-3 cursor-pointer hover:bg-[aliceblue] dark:hover:bg-[#5556565c] rounded-lg   py-4 pl-2 pr-8">
            <FaRegUser size={20} />
        ...
        <Link to={`/profile/${userData.user?.username}`}>
          <div className="w-8 flex items-center gap-3 cursor-pointer lg:hidden">
            <img
              ...
              src="https://i.imgur.com/2MVjicu.png"
              alt="logo"
              srcset=""
            />
