...
function HomePage() {
  return (
    <>
      <div className="relative flex justify-center bg-[#edf7ff]">
        {/* // HEADER_SECTION */}
        <Header />

        {/* BODY_SECTION POST CARD  */}
        <div className="mt-8 lg:p-8 bg-slate-100 lg:w-w-45">
          ...
          <div className=" lg:overflow-y-auto lg:h-[35.5rem]">
            <Card />
            <Card />
            <Card />
            <Card />
      ...
      <div className=" hidden xs:hdden lg:flex lg:flex-col lg:w-80 lg:p-2 lg:gap-6 lg:absolute lg:top-9 lg:right-24 lg:z-20 lg:bg-zinc-200 lg:rounded-tr-3xl ">
